...
from data.parser.from_mrp.evt_ent_parser import EvtEntParser
from data.parser.from_mrp.evt_parser import EvtParser
...
class Dataset:
    ...
    def load_dataset(self, args, framework: str, language: str):

        parser = {
            ("ace_p_evt", "en"): EvtParser, ("ace_p_evt", "zh"): EvtParser,
            ("ace_p_evt_ent", "en"): EvtEntParser, ("ace_p_evt_ent", "zh"): EvtEntParser,
            ("ace_pp_evt", "en"): EvtParser, ("ace_pp_evt", "zh"): EvtParser,
            ("ace_pp_evt_ent", "en"): EvtEntParser, ("ace_pp_evt_ent", "zh"): EvtEntParser,
            ("ere_p_evt", "en"): EvtParser, ("ere_p_evt", "zh"): EvtParser, ("ere_p_evt", "es"): EvtParser,
            ("ere_p_evt_ent", "en"): EvtEntParser, ("ere_p_evt_ent", "zh"): EvtEntParser, ("ere_p_evt_ent", "es"): EvtEntParser,
            ("ere_pp_evt", "en"): EvtParser, ("ere_pp_evt", "zh"): EvtParser, ("ere_pp_evt", "es"): EvtParser,
            ("ere_pp_evt_ent", "en"): EvtEntParser, ("ere_pp_evt_ent", "zh"): EvtEntParser, ("ere_pp_evt_ent", "es"): EvtEntParser,
        }[(framework, language)]
        ...
        del self.train.data, self.val.data, self.test.data  # TODO: why?
        for f in list(self.train.fields.values()) + list(self.val.fields.values()) + list(self.test.fields.values()):  # TODO: why?
        ...
        print(list(self.label_field.vocab.freqs.keys()), flush=True)
